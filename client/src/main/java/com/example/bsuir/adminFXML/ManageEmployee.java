...
import com.example.bsuir.enums.Roles;
...
public class ManageEmployee implements Initializable {
    ...
    public void OnBack() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/adminFXML/adminAccount.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void OnAdd() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/adminFXML/AddUpdateEmployee.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
