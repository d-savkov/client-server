package com.example.bsuir.userFXML;
...
import com.example.bsuir.models.EmployeeModel;
import com.example.bsuir.utils.ClientSocket;
import com.example.bsuir.utils.GetService;
...
public class Employee implements Initializable{
    ...
    public void OnBack() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/userFXML/account.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        GetService<com.example.bsuir.models.entities.Employee> batchGetService = new GetService<>(
                com.example.bsuir.models.entities.Employee.class);
        Type listType = new TypeToken<ArrayList<com.example.bsuir.models.entities.Employee>>() {
        }.getType();
        List<com.example.bsuir.models.entities.Employee> employees = new Gson().fromJson(batchGetService.GetEntities(Requests.GET_ALL_EMPLOYEES), listType);
        ObservableList<EmployeeModel> list = FXCollections.observableArrayList();
        if (employees.size() != 0)
            for (com.example.bsuir.models.entities.Employee employee : employees) {
