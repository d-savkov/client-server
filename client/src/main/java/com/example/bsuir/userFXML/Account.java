...
public class Account implements Initializable {
    ...
    public void Employee_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/userFXML/Employee.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void Services_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/userFXML/Services.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
    ...
    public void Get_Information_Pressed() throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/userFXML/ClientAppointments.fxml"));
        Scene newScene = new Scene(root);
        stage.setScene(newScene);
    }
